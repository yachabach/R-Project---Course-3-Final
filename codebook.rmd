...
This is an example of the structure of tidy_dataset.  It is ordered by Subject and then by activity.  Since Activity is a factor, it is ordered by the file Activity_Labels.txt in the original data.  This sample only displays the means of first 3 of 86 mean motion variables.  

```{r show_sample}

knitr::kable(tidy_set[1:20, 1:5], align = 'clcccc')
```
